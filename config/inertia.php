...
return [
    ...
    */
    ...
    |
    | NOTE: this project's pages live under resources/js/pages (lowercase),
    | not the package default resources/js/Pages - overridden below. The
    | mismatch is invisible on case-insensitive filesystems (Windows/macOS)
    | but breaks assertInertia()->component() assertions on case-sensitive
    | ones (Linux, including GitHub Actions runners).
    |
    */
